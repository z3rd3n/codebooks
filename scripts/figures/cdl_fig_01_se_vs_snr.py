...
Runs scripts/figures/fig_01_se_vs_snr.py on a 3GPP CDL channel (default CDL-C, 3 km/h)
into results/sionna_cdl_gallery/.  See the matching .md for the analysis.

Run: .venv/bin/python scripts/figures/cdl_fig_01_se_vs_snr.py [--fast --drops N --seed S --model C]
"""
