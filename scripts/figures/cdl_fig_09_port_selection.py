...
Runs scripts/figures/fig_09_port_selection.py on a 3GPP CDL channel (default CDL-C)
...
Run: .venv/bin/python scripts/figures/cdl_fig_09_port_selection.py [--fast --drops N --model C]
"""
